...
export default function OrganizerPage() {
  ...
  const totalViews = events.reduce((acc, e) => acc + (e.viewCount || 0), 0);
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/submit" className="btn-primary flex items-center gap-2 text-sm">
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 text-sm mb-4">Publie ton premier événement !</p>
