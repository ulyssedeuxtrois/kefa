...
### Ce que tu possèdes
- La marque "Ziben" (non déposée — à déposer à l'INPI si tu veux la protéger, ~250 € pour 10 ans)
...
Les events publiés appartiennent aux organisateurs. En publiant, ils accordent à Ziben une licence d'affichage (mentionné dans les CGU).
...
Les organisateurs sont responsables de leurs events. Ziben n'est qu'un intermédiaire technique (statut d'hébergeur au sens de la LCEN). Ce statut exonère Ziben de la responsabilité du contenu sauf si le contenu illicite lui est signalé et qu'il n'est pas retiré promptement.
...
- [ ] Déposer la marque "Ziben" à l'INPI (si budget dispo)
